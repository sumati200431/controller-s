...
for i = 1:length(tspan)-1
    ...
    dx_state = zeros(4,1);
    dx_state(1) = r_dot;
    dx_state(2) = g*sin(theta) - r*theta_dot^2*theta*5/7 - ball_friction*r_dot;
    dx_state(3) = theta_dot;
    dx_state(4) = (tau - ms * g * r *theta - 2 * ms * r * r_dot * theta_dot - beam_friction * theta_dot) / (Ib + ms * r^2);
